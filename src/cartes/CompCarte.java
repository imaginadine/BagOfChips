...
public class CompCarte extends Carte {
	private Couleur couleur1;
	private Couleur couleur2;
	
	//constructeur
	
	public CompCarte(int nbPoints, String cat, String arg) {
	...
	*/
	...
	public boolean estReussie(Manche manche) {
		...
		//condition : s'il y a plus de chips d'une couleur que de l'autre
	...
	public String toString() {
		...
		res += "il y a strictement plus de chips de couleur " + couleur1 + " que de chips de couleur " + couleur2 + "\n";
		return res;
	}
}
